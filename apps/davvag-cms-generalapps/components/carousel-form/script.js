WEBDOCK.component().register(function(exports){
    ...
    var vueData =   {
        methods: {
            ...
            remove:function(i){
                filteredItems = bindData.product.carouselitems.filter(function(item) {
                    if(item.imgurl!==i.imgurl)
                        return item;
                });
                scope.product.carouselitems=filteredItems==null?[]:filteredItems;
                showSlides(scope.product.carouselitems.length-1);
            },
            crope:function(){
            ...
            addItem:function(i){
                if(!bindData.product.carouselitems){bindData.product.carouselitems=[]}
                bindData.product.carouselitems.push({id:bindData.product.carouselitems.length,catid:bindData.product.catid,title:i.title,
                        ...
                        .then(function(r){
                            ...
                            if(r.success){
                                ...
                                if(r.result.d_cms_carousel_dtl_v1.length!=0){
                                    bindData.product.carouselitems=r.result.d_cms_carousel_dtl_v1;
  ...
  dots[slideIndex-1].className += " active";
    ...
    function submit(){
        ...
        if (!scope.submitErrors){
            ...
            bindData.product.carouselitems.forEach(element => {
