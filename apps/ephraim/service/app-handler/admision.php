...
<tr>
    ...
    <td class="tg-0pky-value" colspan="2">
      <?php echo htmlspecialchars($data->id . "-" . $data->profileid . "-" . $data->regdate); ?>
    </td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td class="tg-0pky-value" colspan="2"> 
      <?php echo htmlspecialchars($data->id_number); ?>
    </td>
  </tr>
  <tr>
    ...
    <td class="tg-0pky-value" colspan="2">
      <?php
        $res = SOSSData::Query("attr_projects", "ID:" . $data->projectid);
        if (count($res->result) > 0) {
          echo htmlspecialchars($res->result[0]->reg_complete);
        }
      ?>
    </td>
  </tr>
  <tr>
    ...
    <td class="tg-0pky-value" colspan="2"><?php echo htmlspecialchars($data->medicremarks); ?></td>
  </tr>
  <tr>
    ...
    <td class="tg-0pky-value" colspan="2">
      <?php
        ...
        if (count($res->result) > 0) {
          echo htmlspecialchars($res->result[0]->name . " (" . $res->result[0]->contactno . ")");
        } else {
