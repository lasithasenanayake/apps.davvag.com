WEBDOCK.component().register(function (exports) {
    ...
    function loadReport() {
        ...
        api.services.WorkLogDetailed(reportRequest()).then(function (response) {
            ...
            if (!response.success) {
                ...
                setError("Could not load the detailed work log report.");
                return;
            }
    ...
    function openSummary() {
        navigate("../task-work-log-summery" + filterQuery());
    }
